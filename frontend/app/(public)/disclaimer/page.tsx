        ...
        >
          ...
          <div className="prose prose-invert max-w-none prose-headings:font-heading prose-headings:uppercase prose-a:text-brand-gold">
            <p className="text-xl text-white/80 leading-relaxed mb-8">
              The fitness and nutritional information provided by Milestone Energym is for educational purposes only. You should consult your physician before starting any new exercise or diet program.
            </p>
