        ...
        >
          ...
          <div className="prose prose-invert max-w-none prose-headings:font-heading prose-headings:uppercase prose-a:text-brand-gold">
            <p className="text-xl text-white/80 leading-relaxed mb-8">
              We understand that circumstances change. Our cancellation policy is designed to be fair and transparent. Monthly rolling contracts require a 30-day notice period for cancellation.
            </p>
