...
export default function ClientTransformationsPage() {
  return (
        ...
        >
          ...
          <div className="glass p-12 rounded-2xl border border-white/5 flex flex-col items-center justify-center min-h-[400px]">
             ...
             <p className="text-white/50 text-center max-w-md">
               We are working hard to bring you the best experience. The Client Transformations page will be available shortly.
             </p>
          </div>
        </motion.div>
      </div>
