        ...
        >
          ...
          <div className="prose prose-invert max-w-none prose-headings:font-heading prose-headings:uppercase prose-a:text-brand-gold">
            <p className="text-xl text-white/80 leading-relaxed mb-8">
              Your safety is our top priority. We maintain strict hygiene protocols and equipment maintenance schedules. Members are expected to wipe down machines after use and follow staff instructions.
            </p>
